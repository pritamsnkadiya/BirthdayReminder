...
Check performed at Mon Jun 17 17:28:00 IST 2019      </nav>
    </div>
  </header>
  <div class="mdl-layout__drawer">
    ...
    <nav class="mdl-navigation">
      ...
      <a class="mdl-navigation__link" href="#ExifInterface"><i class="material-icons warning-icon">warning</i>Using <code>android.media.ExifInterface</code> (1)</a>
...
<a href="#ExifInterface">ExifInterface</a>: Using <code>android.media.ExifInterface</code></td></tr>
<tr>
<td class="countColumn">1</td><td class="issueColumn"><i class="material-icons warning-icon">warning</i>
...
<section class="section--center mdl-grid mdl-grid--no-spacing mdl-shadow--2dp" id="ExifInterfaceCard" style="display: block;">
            <div class="mdl-card mdl-cell mdl-cell--12-col">
  <div class="mdl-card__title">
    <h2 class="mdl-card__title-text">Using android.media.ExifInterface</h2>
  </div>
              <div class="mdl-card__supporting-text">
<div class="issue">
<div class="warningslist">
<span class="location"><a href="../../src/main/java/com/imagepicker/utils/MediaUtils.java">../../src/main/java/com/imagepicker/utils/MediaUtils.java</a>:7</span>: <span class="message">Avoid using <code>android.media.ExifInterface</code>; use <code>android.support.media.ExifInterface</code> from the support library instead</span><br /><pre class="errorlines">
<span class="lineno">   4 </span><span class="keyword">import</span> android.graphics.Bitmap;
<span class="lineno">   5 </span><span class="keyword">import</span> android.graphics.BitmapFactory;
<span class="lineno">   6 </span><span class="keyword">import</span> android.graphics.Matrix;
<span class="caretline"><span class="lineno">   7 </span><span class="keyword">import</span> <span class="warning">android.media.ExifInterface</span>;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</span>
<span class="lineno">   8 </span><span class="keyword">import</span> android.media.MediaScannerConnection;
<span class="lineno">   9 </span><span class="keyword">import</span> android.net.Uri;
<span class="lineno">  10 </span><span class="keyword">import</span> android.os.Environment;
</pre>

</div>
<div class="metadata"><div class="explanation" id="explanationExifInterface" style="display: none;">
...
<div class="chips">
<span class="mdl-chip">
    <span class="mdl-chip__text">ExifInterface</span>
</span>
<span class="mdl-chip">
...
<span class="mdl-chip">
    <span class="mdl-chip__text">Priority 6/10</span>
              ...
              <div class="mdl-card__actions mdl-card--border">
<button class="mdl-button mdl-js-button mdl-js-ripple-effect" id="explanationExifInterfaceLink" onclick="reveal('explanationExifInterface');">
Explain</button><button class="mdl-button mdl-js-button mdl-js-ripple-effect" id="ExifInterfaceCardLink" onclick="hideid('ExifInterfaceCard');">
Dismiss</button>            </div>
            </div>
...
<div class="issue">
<div class="warningslist">
<span class="location"><a href="../../src/main/java/com/imagepicker/ImagePickerModule.java">../../src/main/java/com/imagepicker/ImagePickerModule.java</a>:632</span>: <span class="message">Field requires API level 17 (current min is 16): <code>android.content.pm.PackageManager#FEATURE_CAMERA_ANY</code></span><br /><pre class="errorlines">
<span class="lineno"> 629 </span>
<span class="lineno"> 630 </span>  <span class="keyword">private</span> <span class="keyword">boolean</span> isCameraAvailable() {
<span class="lineno"> 631 </span>    <span class="keyword">return</span> reactContext.getPackageManager().hasSystemFeature(PackageManager.FEATURE_CAMERA)
<span class="caretline"><span class="lineno"> 632 </span>      || reactContext.getPackageManager().hasSystemFeature(<span class="warning">PackageManager.FEATURE_CAMERA_ANY</span>);&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</span>
<span class="lineno"> 633 </span>  }
<span class="lineno"> 634 </span>
<span class="lineno"> 635 </span>  <span class="keyword">private</span> <span class="annotation">@NonNull</span> String getRealPathFromURI(<span class="annotation">@NonNull</span> <span class="keyword">final</span> Uri uri) {
</pre>
...
<div class="issue">
<div class="warningslist">
<span class="location"><a href="../../src/main/java/com/imagepicker/utils/MediaUtils.java">../../src/main/java/com/imagepicker/utils/MediaUtils.java</a>:180</span>: <span class="message">Try-with-resources requires API level 19 (current min is 16)</span><br /><pre class="errorlines">
<span class="lineno"> 177 </span>
<span class="lineno"> 178 </span>        result = result.withResizedFile(resized);
<span class="lineno"> 179 </span>
<span class="caretline"><span class="lineno"> 180 </span>        <span class="keyword">try</span> (<span class="error">FileOutputStream fos = <span class="keyword">new</span> FileOutputStream(result.resized)</span>)&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</span>
<span class="lineno"> 181 </span>        {
<span class="lineno"> 182 </span>            bytes.writeTo(fos);
...
<div class="issue">
<div class="warningslist">
<span class="location"><a href="../../src/main/java/com/imagepicker/utils/MediaUtils.java">../../src/main/java/com/imagepicker/utils/MediaUtils.java</a>:261</span>: <span class="message">To get local formatting use <code>getDateInstance()</code>, <code>getDateTimeInstance()</code>, or <code>getTimeInstance()</code>, or use <code>new SimpleDateFormat(String template, Locale locale)</code> with for example <code>Locale.US</code> for ASCII dates.</span><br /><pre class="errorlines">
<span class="lineno"> 258 </span>  }
<span class="lineno"> 259 </span>
<span class="lineno"> 260 </span>  <span class="keyword">final</span> String timestamp = exif.getAttribute(ExifInterface.TAG_DATETIME);
<span class="caretline"><span class="lineno"> 261 </span>  <span class="keyword">final</span> SimpleDateFormat exifDatetimeFormat = <span class="warning"><span class="keyword">new</span> SimpleDateFormat(<span class="string">"yyyy:MM:dd HH:mm:ss"</span>)</span>;</span>
<span class="lineno"> 262 </span>
<span class="lineno"> 263 </span>  <span class="keyword">final</span> DateFormat isoFormat = <span class="keyword">new</span> SimpleDateFormat(<span class="string">"yyyy-MM-dd'T'HH:mm:ss"</span>);
<span class="lineno"> 264 </span>  isoFormat.setTimeZone(TimeZone.getTimeZone(<span class="string">"UTC"</span>));
</pre>

<span class="location"><a href="../../src/main/java/com/imagepicker/utils/MediaUtils.java">../../src/main/java/com/imagepicker/utils/MediaUtils.java</a>:263</span>: <span class="message">To get local formatting use <code>getDateInstance()</code>, <code>getDateTimeInstance()</code>, or <code>getTimeInstance()</code>, or use <code>new SimpleDateFormat(String template, Locale locale)</code> with for example <code>Locale.US</code> for ASCII dates.</span><br /><pre class="errorlines">
<span class="lineno"> 260 </span>  <span class="keyword">final</span> String timestamp = exif.getAttribute(ExifInterface.TAG_DATETIME);
<span class="lineno"> 261 </span>  <span class="keyword">final</span> SimpleDateFormat exifDatetimeFormat = <span class="keyword">new</span> SimpleDateFormat(<span class="string">"yyyy:MM:dd HH:mm:ss"</span>);
<span class="lineno"> 262 </span>
<span class="caretline"><span class="lineno"> 263 </span>  <span class="keyword">final</span> DateFormat isoFormat = <span class="warning"><span class="keyword">new</span> SimpleDateFormat(<span class="string">"yyyy-MM-dd'T'HH:mm:ss"</span>)</span>;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</span>
<span class="lineno"> 264 </span>  isoFormat.setTimeZone(TimeZone.getTimeZone(<span class="string">"UTC"</span>));
<span class="lineno"> 265 </span>
<span class="lineno"> 266 </span>  <span class="keyword">try</span></pre>
...
<div class="issue">
<div class="warningslist">
<span class="location"><a href="../../build.gradle">../../build.gradle</a>:17</span>: <span class="message">A newer version of com.android.tools.build:gradle than 3.1.4 is available: 3.4.1</span><br /><pre class="errorlines">
<span class="lineno"> 14 </span>    }
<span class="lineno"> 15 </span>
<span class="lineno"> 16 </span>    dependencies {
<span class="caretline"><span class="lineno"> 17 </span>        <span class="warning">classpath <span class="string">'com.android.tools.build:gradle:3.1.4'</span></span>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</span>
<span class="lineno"> 18 </span>    }
<span class="lineno"> 19 </span>}
</pre>

<span class="location"><a href="../../build.gradle">../../build.gradle</a>:56</span>: <span class="message">A newer version of junit:junit than 4.10 is available: 4.12</span><br /><pre class="errorlines">
<span class="lineno"> 53 </span>dependencies {
<span class="lineno"> 54 </span>    implementation <span class="string">"com.facebook.react:react-native:+"</span>  <span class="comment">// From node_modules</span>
<span class="lineno"> 55 </span>
<span class="caretline"><span class="lineno"> 56 </span>    <span class="warning">testImplementation <span class="string">"junit:junit:4.10"</span></span>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</span>
<span class="lineno"> 57 </span>    testImplementation <span class="string">"org.assertj:assertj-core:1.7.0"</span>
<span class="lineno"> 58 </span>    testImplementation <span class="string">"org.robolectric:robolectric:3.3.2"</span>
</pre>

<span class="location"><a href="../../build.gradle">../../build.gradle</a>:57</span>: <span class="message">A newer version of org.assertj:assertj-core than 1.7.0 is available: 2.6.0</span><br /><pre class="errorlines">
<span class="lineno"> 54 </span>    implementation <span class="string">"com.facebook.react:react-native:+"</span>  <span class="comment">// From node_modules</span>
<span class="lineno"> 55 </span>
<span class="lineno"> 56 </span>    testImplementation <span class="string">"junit:junit:4.10"</span>
<span class="caretline"><span class="lineno"> 57 </span>    <span class="warning">testImplementation <span class="string">"org.assertj:assertj-core:1.7.0"</span></span>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</span>
<span class="lineno"> 58 </span>    testImplementation <span class="string">"org.robolectric:robolectric:3.3.2"</span>
<span class="lineno"> 59 </span>
<span class="lineno"> 60 </span>    testImplementation <span class="string">"org.easytesting:fest-assert-core:${FEST_ASSERT_CORE_VERSION}"</span></pre>
...
<div class="issue">
<div class="warningslist">
<span class="location"><a href="../../build.gradle">../../build.gradle</a>:54</span>: <span class="message">Avoid using + in version numbers; can lead to unpredictable and unrepeatable builds (com.facebook.react:react-native:+)</span><br /><pre class="errorlines">
<span class="lineno"> 51 </span>}
<span class="lineno"> 52 </span>
<span class="lineno"> 53 </span>dependencies {
<span class="caretline"><span class="lineno"> 54 </span>    <span class="warning">implementation <span class="string">"com.facebook.react:react-native:+"</span>  <span class="comment">// From node_modules</span></span>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</span>
<span class="lineno"> 55 </span>
<span class="lineno"> 56 </span>    testImplementation <span class="string">"junit:junit:4.10"</span>
<span class="lineno"> 57 </span>    testImplementation <span class="string">"org.assertj:assertj-core:1.7.0"</span></pre>
