...
<div class="mdl-layout mdl-js-layout mdl-layout--fixed-header">
  <header class="mdl-layout__header">
    <div class="mdl-layout__header-row">
      <span class="mdl-layout-title">Lint Report: 1 error and 7 warnings</span>
      <div class="mdl-layout-spacer"></div>
      <nav class="mdl-navigation mdl-layout--large-screen-only">
Check performed at Mon Jun 17 17:27:54 IST 2019      </nav>
    </div>
  </header>
...
<span class="location"><a href="../../src/main/java/com/rnfs/Uploader.java">../../src/main/java/com/rnfs/Uploader.java</a>:180</span>: <span class="message">Implicitly using the default locale is a common source of bugs: Use <code>toLowerCase(Locale)</code> instead. For strings meant to be internal use <code>Locale.ROOT</code>, otherwise <code>Locale.getDefault()</code>.</span><br /><pre class="errorlines">
<span class="lineno"> 177 </span>  String type = <span class="keyword">null</span>;
<span class="lineno"> 178 </span>  String extension = MimeTypeMap.getFileExtensionFromUrl(path);
<span class="lineno"> 179 </span>  <span class="keyword">if</span> (extension != <span class="keyword">null</span>) {
<span class="caretline"><span class="lineno"> 180 </span>      type = MimeTypeMap.getSingleton().getMimeTypeFromExtension(extension.<span class="warning">toLowerCase</span>());&nbsp;&nbsp;&nbsp;&nbsp;</span>
<span class="lineno"> 181 </span>  }
<span class="lineno"> 182 </span>  <span class="keyword">if</span> (type == <span class="keyword">null</span>) {
<span class="lineno"> 183 </span>      type = <span class="string">"*/*"</span>;
</pre>
...
<div class="issue">
<div class="warningslist">
<span class="location"><a href="../../src/main/java/com/rnfs/RNFSManager.java">../../src/main/java/com/rnfs/RNFSManager.java</a>:837</span>: <span class="message">Call requires API level 19 (current min is 16): <code>android.content.ContextWrapper#getExternalFilesDirs</code></span><br /><pre class="errorlines">
<span class="lineno"> 834 </span>
<span class="lineno"> 835 </span>  <span class="annotation">@ReactMethod</span>
<span class="lineno"> 836 </span>  <span class="keyword">public</span> <span class="keyword">void</span> getAllExternalFilesDirs(Promise promise){
<span class="caretline"><span class="lineno"> 837 </span>    File[] allExternalFilesDirs = <span class="keyword">this</span>.getReactApplicationContext().<span class="error">getExternalFilesDirs</span>(<span class="keyword">null</span>);&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</span>
<span class="lineno"> 838 </span>    WritableArray fs = Arguments.createArray();
<span class="lineno"> 839 </span>    <span class="keyword">for</span> (File f : allExternalFilesDirs) {
<span class="lineno"> 840 </span>      fs.pushString(f.getAbsolutePath());
</pre>
...
<div class="issue">
<div class="warningslist">
<span class="location"><a href="../../build.gradle">../../build.gradle</a>:11</span>: <span class="message">A newer version of com.android.tools.build:gradle than 1.5.0 is available: 3.4.1</span><br /><pre class="errorlines">
<span class="lineno">  8 </span>    }
<span class="lineno">  9 </span>
<span class="lineno"> 10 </span>    dependencies {
<span class="caretline"><span class="lineno"> 11 </span>        <span class="warning">classpath <span class="string">'com.android.tools.build:gradle:1.5.0'</span></span>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</span>
...
<div class="issue">
<div class="warningslist">
<span class="location"><a href="../../src/main/java/com/rnfs/RNFSManager.java">../../src/main/java/com/rnfs/RNFSManager.java</a>:90</span>: <span class="message">This <code>Cursor</code> should be freed up after use with <code>#close()</code></span><br /><pre class="errorlines">
<span class="lineno">  87 </span>  String originalFilepath = filepath;
<span class="lineno">  88 </span>  <span class="keyword">if</span> (uri.getScheme().equals(<span class="string">"content"</span>)) {
<span class="lineno">  89 </span>    <span class="keyword">try</span> {
<span class="caretline"><span class="lineno">  90 </span>      Cursor cursor = reactContext.getContentResolver().<span class="warning">query</span>(uri, <span class="keyword">null</span>, <span class="keyword">null</span>, <span class="keyword">null</span>, <span class="keyword">null</span>);&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</span>
<span class="lineno">  91 </span>      <span class="keyword">if</span> (cursor.moveToFirst()) {
<span class="lineno">  92 </span>        originalFilepath = cursor.getString(cursor.getColumnIndexOrThrow(MediaStore.Images.Media.DATA));
...
<div class="issue">
<div class="warningslist">
<span class="location"><a href="../../src/main/java/com/rnfs/RNFSManager.java">../../src/main/java/com/rnfs/RNFSManager.java</a>:327</span>: <span class="message">This <code>AsyncTask</code> class should be static or leaks might occur (anonymous com.rnfs.RNFSManager.CopyFileTask)</span><br /><pre class="errorlines">
<span class="lineno"> 324 </span>      <span class="keyword">final</span> File inFile = <span class="keyword">new</span> File(filepath);
<span class="lineno"> 325 </span>
<span class="lineno"> 326 </span>      <span class="keyword">if</span> (!inFile.renameTo(<span class="keyword">new</span> File(destPath))) {
<span class="caretline"><span class="lineno"> 327 </span>        <span class="warning"><span class="keyword">new</span> CopyFileTask() {</span>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</span>
<span class="lineno"> 328 </span>          <span class="annotation">@Override</span>
<span class="lineno"> 329 </span>          <span class="keyword">protected</span> <span class="keyword">void</span> onPostExecute (Exception ex) {
<span class="lineno"> 330 </span>            <span class="keyword">if</span> (ex == <span class="keyword">null</span>) {
</pre>

<span class="location"><a href="../../src/main/java/com/rnfs/RNFSManager.java">../../src/main/java/com/rnfs/RNFSManager.java</a>:350</span>: <span class="message">This <code>AsyncTask</code> class should be static or leaks might occur (anonymous com.rnfs.RNFSManager.CopyFileTask)</span><br /><pre class="errorlines">
<span class="lineno"> 347 </span>
<span class="lineno"> 348 </span>  <span class="annotation">@ReactMethod</span>
<span class="lineno"> 349 </span>  <span class="keyword">public</span> <span class="keyword">void</span> copyFile(<span class="keyword">final</span> String filepath, <span class="keyword">final</span> String destPath, ReadableMap options, <span class="keyword">final</span> Promise promise) {
<span class="caretline"><span class="lineno"> 350 </span>    <span class="warning"><span class="keyword">new</span> CopyFileTask() {</span>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</span>
<span class="lineno"> 351 </span>      <span class="annotation">@Override</span>
<span class="lineno"> 352 </span>      <span class="keyword">protected</span> <span class="keyword">void</span> onPostExecute (Exception ex) {
<span class="lineno"> 353 </span>        <span class="keyword">if</span> (ex == <span class="keyword">null</span>) {
</pre>

<span class="location"><a href="../../src/main/java/com/rnfs/RNFSManager.java">../../src/main/java/com/rnfs/RNFSManager.java</a>:363</span>: <span class="message">This <code>AsyncTask</code> class should be static or leaks might occur (com.rnfs.RNFSManager.CopyFileTask)</span><br /><pre class="errorlines">
<span class="lineno"> 360 </span>    }.execute(filepath, destPath);
<span class="lineno"> 361 </span>  }
<span class="lineno"> 362 </span>
<span class="caretline"><span class="lineno"> 363 </span>  <span class="keyword">private</span> <span class="keyword">class</span> <span class="warning">CopyFileTask</span> <span class="keyword">extends</span> AsyncTask&lt;String, Void, Exception> {&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</span>
<span class="lineno"> 364 </span>    <span class="keyword">protected</span> Exception doInBackground(String... paths) {
<span class="lineno"> 365 </span>      <span class="keyword">try</span> {
<span class="lineno"> 366 </span>        String filepath = paths[<span class="number">0</span>];
</pre>
