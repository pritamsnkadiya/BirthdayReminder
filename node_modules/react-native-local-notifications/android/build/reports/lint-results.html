...
Check performed at Mon Jun 17 17:28:15 IST 2019      </nav>
    </div>
  </header>
  <div class="mdl-layout__drawer">
    ...
    <nav class="mdl-navigation">
      ...
      <a class="mdl-navigation__link" href="#SimpleDateFormat"><i class="material-icons warning-icon">warning</i>Implied locale in date format (1)</a>
...
<span class="location"><a href="../../src/main/java/com/github/wumke/RNLocalNotifications/RNLocalNotificationsModule.java">../../src/main/java/com/github/wumke/RNLocalNotifications/RNLocalNotificationsModule.java</a>:66</span>: <span class="message">To get local formatting use <code>getDateInstance()</code>, <code>getDateTimeInstance()</code>, or <code>getTimeInstance()</code>, or use <code>new SimpleDateFormat(String template, Locale locale)</code> with for example <code>Locale.US</code> for ASCII dates.</span><br /><pre class="errorlines">
<span class="lineno">  63 </span>            <span class="keyword">this</span>.deleteAlarm(id);
<span class="lineno">  64 </span>        }
<span class="lineno">  65 </span>
<span class="caretline"><span class="lineno">  66 </span>        <span class="keyword">final</span> SimpleDateFormat desiredFormat = <span class="warning"><span class="keyword">new</span> SimpleDateFormat(<span class="string">"yyyy-MM-dd kk:mm"</span>)</span>;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</span>
<span class="lineno">  67 </span>        Date dateToMillis = <span class="keyword">null</span>;
<span class="lineno">  68 </span>        <span class="keyword">try</span> {
<span class="lineno">  69 </span>            dateToMillis = desiredFormat.parse(datetime);
</pre>
...
<div class="issue">
<div class="warningslist">
<span class="location"><a href="../../build.gradle">../../build.gradle</a>:26</span>: <span class="message">Avoid using + in version numbers; can lead to unpredictable and unrepeatable builds (com.facebook.react:react-native:+)</span><br /><pre class="errorlines">
<span class="lineno"> 23 </span>}
<span class="lineno"> 24 </span>
<span class="lineno"> 25 </span>dependencies {
<span class="caretline"><span class="lineno"> 26 </span>    <span class="warning">compile <span class="string">'com.facebook.react:react-native:+'</span></span>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</span>
<span class="lineno"> 27 </span>    compile <span class="string">'com.android.support:support-v4:+'</span>
<span class="lineno"> 28 </span>}
</pre>

<span class="location"><a href="../../build.gradle">../../build.gradle</a>:27</span>: <span class="message">Avoid using + in version numbers; can lead to unpredictable and unrepeatable builds (com.android.support:support-v4:+)</span><br /><pre class="errorlines">
<span class="lineno"> 24 </span>
<span class="lineno"> 25 </span>dependencies {
<span class="lineno"> 26 </span>    compile <span class="string">'com.facebook.react:react-native:+'</span>
<span class="caretline"><span class="lineno"> 27 </span>    <span class="warning">compile <span class="string">'com.android.support:support-v4:+'</span></span>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</span>
<span class="lineno"> 28 </span>}
</pre>
